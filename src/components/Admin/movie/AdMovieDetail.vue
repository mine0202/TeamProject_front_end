      ...
      <div v-if="currentMovie">
        <div class="cc_tab_content">
          ...
          <div v-if="!modify">
            <table class="tb_acc_wrap">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    {{ currentMovie.msimpleInfo }}
                  </td>
                </tr>
                <tr>
                  <th scope="row">감독 <span class="txt_req">*</span></th>
                  <td>
                    {{ currentMovie.mdirector }}
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    {{ currentMovie.mrunningTime }}
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                    상영 시작일 <span class="txt_req">*</span>
                  </th>
                  <td>
                    {{ currentMovie.mreleaseDate }}
                  </td>
                </tr>
                <tr>
                  <th scope="row">
                    상영 종료일 <span class="txt_req">*</span>
                  </th>
                  <td>
                    {{ currentMovie.mclosingDate }}
                  </td>
                </tr>
                <tr>
                  <th scope="row">트레일러 링크 <span class="txt_req">*</span></th>
                  <td>
                    {{ currentMovie.mtrailerLink }}
                  </td>
                </tr>
                <tr>
            ...
            <div class="btn_btm_wrap">
              <router-link class="btn_col3 ty6" to="/admin-movie"
                >취소</router-link
              >
              <button @click="modifyMovie" class="btn_col2 ty6">
                수정하기
              </button>
            </div>
          </div>
          ...
          <div v-else>
                  ...
                  <td>
                    <div class="qna_textarea">
                      <textarea
                        ...
                        v-model="currentMovie.msimpleInfo"
                        required
                      ></textarea>
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="bx_textarea">
                      <input
                        ...
                        title="영화감독 입력"
                        id="mdirector"
                        v-model="currentMovie.mdirector"
                        required
                      />
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="bx_textarea">
                      <input
                        ...
                        title="상영시간 입력"
                        id="mrunningTime"
                        v-model="currentMovie.mrunningTime"
                        required
                      />
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="bx_textarea">
                      <input
                        ...
                        title="상영시작일 입력"
                        id="mreleaseDate"
                        v-model="currentMovie.mreleaseDate"
                        required
                      />
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="bx_textarea">
                      <input
                        ...
                        title="상영종료일 입력"
                        id="mclosingDate"
                        v-model="currentMovie.mclosingDate"
                        required
                      />
                    </div>
                  </td>
                  ...
                  <td>
                    <div class="bx_textarea">
                      <input
                        ...
                        title="트레일러 링크 입력"
                        id="mtrailerLink"
                        v-model="currentMovie.mtrailerLink"
                        required
                      />
                    </div>
                  </td>
            ...
            <div class="btn_btm_wrap">
              <button @click="deleteMovie" class="btn_col3 ty6" style="background:red !important ; color:white  !important;">
                영화삭제
              </button>
              <button @click="updateMovie" class="btn_col2 ty6" style="background:white !important ; color:black  !important;">
...
export default {
  ...
  methods: {
    ...
    updateMovie() {
      AdMovieDataService.update(
        this.currentMovie.mid,
        this.currentMovie.mtitle,
        this.currentMovie.mrunningTime,
        this.currentMovie.mcode,
        this.currentMovie.mreleaseDate,
        this.currentMovie.mclosingDate,
        this.currentMovie.mdirector,
        this.currentMovie.mactor,
        this.currentMovie.msimpleInfo,
        this.currentMovie.mtrailerLink,
        this.currentMovie.mage,
        this.currentImage,
        this.currentImage1,
        this.currentImage2,
        this.currentImage3,
        ...
        .then((response) => {
          ...
          this.message1 = "수정 내역을 성공적으로 저장하였습니다.";
        })
        // 실패하면 catch으로 들어옴 : 화면에 실패메세지 출력
        .catch((err) => {
          this.message = "Could not upload the image! " + err;
          this.message1 = "영화정보 수정에 실패하였습니다.";
          this.currentImage = undefined;
        });
    },
    deleteMovie() {
      // axios 공통함수 호출
      AdMovieDataService.delete(this.currentMovie.mid)
        // 성공하면 then() 결과가 전송됨
        .then((response) => {
          console.log(response.data);
  ...
  mounted() {
    initCustom();
    this.message = "";
    this.getMovie(this.$route.params.mid);
  },
};
</script>
