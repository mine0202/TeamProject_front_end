    ...
    <div class="admin-background">
      ...
      <div class="cc_tab_content">
          ...
          <tbody v-for="(data, index) in notice" :key="index">
            <tr>
              ...
              <td class="text-start tb_title" width="auto">
                <router-link style="color: #fff;" :to="'/admin-notice/' + data.ntcNo">
              ...
              <!-- <td width="15%">
                <router-link :to="'/admin-notice/' + data.ntcNo">
        ...
        <div class="btn_btm_wrap">
          <router-link to="/add/admin-notice" class="btn_col2 ty6"
            >공지사항 추가</router-link
          >
        </div>
      </div>
